...
class Enemy(Entity):
    ...
    def import_graphics(self, name):
        ...
        main_path = f'resources/images/graphics/monsters/{name}/'
    ...
    def get_player_distance_direction(self,player):
        ...
        difference_vec = (player_vec - enemy_vec)
        distance = difference_vec.magnitude()

        if distance > 0:
            direction = difference_vec.normalize()
        else:
